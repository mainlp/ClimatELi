...
def alignment_extraction(entities, document, txt_file):
...
if __name__ == "__main__":
    dir_path = "../raw_document/gold_tokenized/"
    ...
    for k, v in sorted(threshold_map.items(), reverse=True):
        json_dir = f'../machine_annotation/wikifier/json/threshold_{v}/'
        ...
        for txt_file in txt_files:
            ...
            alignment_extraction(entities, document, txt_file)
